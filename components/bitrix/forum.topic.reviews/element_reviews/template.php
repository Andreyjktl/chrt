...
?>
		<div class="reviews-reply-buttons">
			<button name="send_button" class="button2" type="submit" onclick="this.form.preview_comment.value = 'N';" tabindex="<?=$tabIndex++;?>" value="<?=GetMessage("OPINIONS_SEND")?>" name="BasketRefresh">
				<span><?=GetMessage("OPINIONS_SEND")?></span>
			</button>
			
			<button name="send_button" class="button2" type="submit" onclick="this.form.preview_comment.value = 'VIEW';" tabindex="<?=$tabIndex++;?>" value="<?=GetMessage("OPINIONS_PREVIEW")?>" name="BasketRefresh">
				<span><?=GetMessage("OPINIONS_PREVIEW")?></span>
			</button>
		</div>
