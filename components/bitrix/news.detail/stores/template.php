...
<tr><td>
	...
	<div class="desc_col_wr">
		...
		<?endif;?>
		<?if($arResult["DISPLAY_PROPERTIES"]["PHONE"]["VALUE"]||$arResult["DISPLAY_PROPERTIES"]["EMAIL"]["SCHEDULE"]):?>
			<div class="right_col<?if(!$arResult["DISPLAY_PROPERTIES"]["ADDRESS"]["VALUE"]&&!$arResult["DISPLAY_PROPERTIES"]["ADDRESS"]["SCHEDULE"]):?> no_left<?endif;?>">
				<?if( !empty($arResult["DISPLAY_PROPERTIES"]["PHONE"]["VALUE"]) ){?>
					<strong><?=GetMessage('PHONES')?></strong>
					<p><?=$arResult["DISPLAY_PROPERTIES"]["PHONE"]["VALUE"]?></p>
				<?}?>
		...
		<?endif;?>
		<?if($arResult["DISPLAY_PROPERTIES"]["ADDRESS"]["VALUE"]||$arResult["DISPLAY_PROPERTIES"]["ADDRESS"]["SCHEDULE"]):?>
			<div class="left_col">
				<?if( !empty($arResult["DISPLAY_PROPERTIES"]["ADDRESS"]["VALUE"]) ){?>
					<strong><?=GetMessage('ADDRESS')?></strong>
					<p><?=$arResult["DISPLAY_PROPERTIES"]["ADDRESS"]["VALUE"]?></p>
