...
$arTemplateParameters['TITLE_BLOCK'] = array(
	...
	'TYPE' => 'STRING',
	'DEFAULT' => GetMessage("TITLE_BLOCK_NAME"),
);
$arTemplateParameters['USE_TITLE_BLOCK'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage("USE_TITLE_BLOCK"),
	'TYPE' => 'CHECKBOX',
	'VALUE' => "Y",
);
$arTemplateParameters['CAN_BUY'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage("CAN_BUY"),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => "Y",
);