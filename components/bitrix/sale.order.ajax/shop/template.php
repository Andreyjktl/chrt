	...
	else
	{
		...
		<div style="display:none;">
			<div id="order_form_id">
				...
				<div align="right">
				<?=bitrix_sessid_post()?>
				<button class="button" type="button" name="submitbutton" onClick="submitForm('Y');" value="<?=GetMessage("SOA_TEMPL_BUTTON")?>"><span><?=GetMessage("SOA_TEMPL_BUTTON")?></span></button>
				</div>
			</div>
		</div>
